...
export default function AutoPhase({data, setData}: {
    ...
    const [climbSpeed, setclimbSpeed] = useState<number>(0)
    const [scoring, setScoring] = useState<boolean>(true)
    const [scoringManual, setScoringManual] = useState<boolean>(false)
    ...
    return (
        <div className="w-screen h-max flex flex-col p-2 select-none gap-4 text-sm">
            ...
            <div className="flex items-center gap-2">
                <div className="text-lg font-semibold shrink-0">Auto</div>
                <button
                    onClick={() => {
