...
as the following copyright notice:

> Copyright (c) 2026 Mai Wu
...
**Permitted purpose** means reviewing the code, but does not
include using, running, modifying for use, or distributing
the software for any productive purpose.

---

## License Grant

To obtain permission to use this software for any purpose
beyond code review, please contact: me@markwu.org
